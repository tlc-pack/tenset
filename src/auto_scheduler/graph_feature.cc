  ...
  void VisitStmt(const Stmt& n) {
    ...
    if (node_to_index.find(n.get()) == node_to_index.end()) {
      ...
      if (primExprType == 6) {
        ...
        newNode.feature[i++] = slog(feature.float_addsub);
        newNode.feature[i++] = slog(feature.float_mul);
        newNode.feature[i++] = slog(feature.float_divmod);
        newNode.feature[i++] = slog(feature.float_cmp);
        newNode.feature[i++] = slog(feature.float_math_func);
        newNode.feature[i++] = slog(feature.float_other_func);
        newNode.feature[i++] = slog(feature.int_mad);
        newNode.feature[i++] = slog(feature.int_addsub);
        newNode.feature[i++] = slog(feature.int_mul);
        newNode.feature[i++] = slog(feature.int_divmod);
        newNode.feature[i++] = slog(feature.int_cmp);
        newNode.feature[i++] = slog(feature.int_math_func);
        newNode.feature[i++] = slog(feature.int_other_func);
        newNode.feature[i++] = slog(feature.bool_op);
        newNode.feature[i++] = slog(feature.select_op);
        newNode.feature[i++] = slog(feature.vec_num);
