...
/*
 * Note: How to add layout rewrite support for a new operator
 *
 * 1. Add auto_scheduler_layout_rewrite in topi compute.
 * 2. Add need_auto_scheduler_layout in op strategy.
 * 3. Fix OpRelation.
 */
