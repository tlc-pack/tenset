"""Make a graph dataset file.

Usage:
python3 make_graph_dataset.py --logs dataset/measure_records/e5-2673/*.json
python3 make_graph_dataset.py --logs dataset/measure_records/e5-2673/*.json --sample-in-files 100
python3 make_graph_dataset.py --preset batch-size-1
"""
import argparse
import glob
import pickle
...
if __name__ == "__main__":
    ...
    auto_scheduler.graph_dataset.make_dataset_from_log_file(
