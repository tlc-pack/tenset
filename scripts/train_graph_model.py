"""Train a graph cost model with a dataset."""
...
from tvm.auto_scheduler.cost_model.graph_model import GraphModel
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", nargs="+", type=str, default=["dataset_graph.pkl"])
    ...
    parser.add_argument("--use-gpu", type=str2bool, nargs='?',
                        ...
                        help="Whether to use GPU for GNN.")
